...
# RDKE Middleware Layer 8.5.3.0 Release Note
...
| Date          | 2026-04-06 20:02:38 UTC |
| Author        | support@rdkcentral.com |


### Middleware Release Details
[Middleware Release 8.5.3.0](https://github.com/rdkcentral/middleware-manifest-rdke/releases/tag/8.5.3.0) has the below enlisted layer combination.
...
| meta-vendor-raspberrypi-release | [4.11.0](https://github.com/rdkcentral/meta-vendor-raspberrypi-release/tree/4.11.0) |
...
| rdke-common-config | [1.0.20](https://github.com/rdkcentral/rdke-common-config/tree/1.0.20) |
...
| meta-middleware-generic-support | [1.17.0](https://github.com/rdkcentral/meta-middleware-generic-support/tree/1.17.0) |
| meta-rdk | [1.17.0](https://github.com/rdkcentral/meta-rdk/tree/1.17.0) |
| meta-rdk-video | [1.17.0](https://github.com/rdkcentral/meta-rdk-video/tree/1.17.0) |
...
Release Details: [https://wiki.rdkcentral.com/spaces/CMF/pages/472990093/8.5.3.0+-+RPI4-+Release+Notes](https://wiki.rdkcentral.com/spaces/CMF/pages/472990093/8.5.3.0+-+RPI4-+Release+Notes)

For RDKE Middleware layer specific build instructions, refer [this](https://github.com/rdkcentral/middleware-manifest-rdke/blob/8.5.3.0/README.md)
