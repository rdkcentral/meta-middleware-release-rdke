...
2. Cross check and update the ***component_urls.conf*** for any new or missing ***component & its url*** for the list of components in the generated `<RDKE_LAYER>PackagesAndVersions.md`. Component's ***url*** can be obtained from respective ***bitbake recipe***.
